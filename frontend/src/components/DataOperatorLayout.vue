        ...
        <el-header class="title">
          <div style="margin-top: 12px; display: inline-block;">
            ...
            <span style="font-size: large; font-family: 'Microsoft YaHei';
                color: black; font-weight: bold;">在线银行系统 数据操作员</span>
            <span style="margin-left: 40px; color:rgba(0, 0, 0, 0.2)">浙江大学软件工程基础课程项目</span>
          </div>
        </el-header>
        <el-container style="width: 100%;">
          <el-aside class="aside" style="position: relative;">
            <el-menu active-text-color="#ffd04b" background-color="#0270c1" default-active="account" text-color="#fff" style="height:100%; width: 100%;" :router="true">
